...
This is similar to previous work by \parencite{duffy1992} in that we model the time betweeen
...
In line with previous research by \textcite{gruenewald1994}, we model S(t) such that the
log odds of having a 